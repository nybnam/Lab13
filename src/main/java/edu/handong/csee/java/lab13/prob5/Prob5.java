...
public class Prob5 {
	...
	public static boolean equals(int[][] m1, int[][] m2) {
		...
		for (int i = 0; i < m1.length; i++) {		// each row
            for (int j = 0; j < m1[i].length; j++)  // each column
            {
                if (m1[i][j] != m2[i][j])
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter list2: "); // print
		 for (int i = 0; i < m2.length; i++){  // each row
		    for (int j = 0; j < m2[i].length; j++) // each column
		                m2[i][j] = keyboard.nextInt(); 	// get integer from keyboard
		 
		    for (i = 0; i < m1.length; i++){ // each row
		    	for (int j = 0; j < m1[i].length; j++) // each column
		 ...
		 for (i = 0; i < m2.length; i++){  // each row
		    for (int j = 0; j < m2[i].length; j++) // each column
